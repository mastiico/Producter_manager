package br.com.marcio.productms.controller;

import br.com.marcio.productms.dto.ProductDTO;
import br.com.marcio.productms.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Void> actived(@PathVariable("id") Long id){
        boolean inactive = service.actived(id);
        return inactive
                ? new ResponseEntity<>(HttpStatus.NO_CONTENT)
                : new ResponseEntity<>(HttpStatus.NOT_FOUND);
    }
